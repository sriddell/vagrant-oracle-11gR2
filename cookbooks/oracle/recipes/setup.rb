...
execute "oracle packages" do
  command "yum -y install libXext.i686 zip unzip binutils compat-libstdc++-33 elfutils-libelf elfutils-libelf-devel glibc glibc-common glibc-devel gcc gcc-c++ libaio libaio-devel libgcc libstdc++ libstdc++-devel make sysstat unixODBC unixODBC.i686 unixODBC-devel unixODBC-devel.i686"
  user "root"
end
